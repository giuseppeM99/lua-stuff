...
function BigNum.setRadix (radix)
...
--  %%%%%%%% --
--BigNum.gcd{{{2
local function gcd( bnum1, bnum2 )
  local a = {}
  local b = {}
  local c = {}
  local d = {}
...
--BigNum.mt.idiv{{{2
function BigNum.mt.idiv( num1, num2 )
  local bnum1 = {}
  local bnum2 = {}
  local bnum3 = BigNum.new()
  local bnum4 = BigNum.new()
...
function BigNum.mt.concat(num1, num2)
...
BigNum.mt.__idiv = BigNum.mt.idiv
...
--concatenation
BigNum.mt.__concat = BigNum.mt.concat

setmetatable( BigNum.mt, { __index = "inexistent field", __newindex = "not available", __metatable = "hidden" } )

--OOP style
setmetatable( BigNum, {__call = function(self, arg) return self.new(arg) end})
